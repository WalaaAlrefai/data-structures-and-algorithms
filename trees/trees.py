...
if __name__ == "__main__":
    ...
    p_tree = BinarySearchTree()
    p_tree.root = TNode(2)
    p_tree.root.left = TNode(7)
    p_tree.root.right = TNode(5)
    p_tree.root.left.left = TNode(2)
    p_tree.root.left.right = TNode(6)

    print (p_tree.in_order())
    p_tree.add(8)
    print (p_tree.in_order())
    print(p_tree.contains(5))
    print(p_tree.contains(1))
    print (p_tree.post_order())
